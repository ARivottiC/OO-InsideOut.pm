# This Makefile is for the OO::InsideOut extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/OO/InsideOut.pm]
...
INST_LIBDIR      = $(INST_LIB)/OO
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/OO
